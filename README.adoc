...
:url-repo: https://github.com/hyperpolymath/asdf-fornax-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-fornax-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-fornax-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-fornax-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Fornax] versions.
...
Fornax is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Fornax versions per project

|**Project Isolation**
|Pin Fornax per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Fornax version
...
=== Installing Fornax Versions

[source,bash]
----
asdf list all fornax
asdf install fornax latest
asdf install fornax 0.1.0
----
...
[source,bash]
----
asdf global fornax 0.1.0
asdf local fornax 0.1.0
asdf current fornax
fornax --version
----
...
* Ensure `fornax` is on PATH after installation.
* Verify the installed version with `fornax --version`.
